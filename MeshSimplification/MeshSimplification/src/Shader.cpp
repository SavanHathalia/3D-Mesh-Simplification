...
void Shader::setVec2(const std::string& name, const float& v1, const float& v2)
{
...
void Shader::setVec4(const std::string& name, const float& v1, const float& v2, const float& v3, const float& v4)
{
